...
# This script takes as input the trees generated by the coMet_ComSim to create a NULL-MODEL by a permutation of the tips. This script will work theoretically with other trees but this 
# type of NULL-MODEL permutation could not be the most suitable. 
...
NM <- foreach(i = 1:length(Trees)) %do% {  # Looping on all of the trees from the multiphylo object tree
  ...
  write.tree(Phylo_tree,paste0(getwd(),"/coMet_ComSim_Outputs/",Scenario,"/Whole_Communities/TreeDistances/Scenario",Scenario,"_Step3_ObservedTrimmed_NullModel",R,".tree"))
  ...
  names(Phylo_NULL) <- paste0("Tree_NULL_MODEL_",1:RepTree)
  # Save it
  write.tree(Phylo_NULL,paste0(getwd(),"/coMet_ComSim_Outputs/",Scenario,"/Whole_Communities/TreeDistances/Scenario",Scenario,"_Step3_MultiPhylo_NullModel",R,".tree"))
  # Return
  return(Phylo_NULL)
